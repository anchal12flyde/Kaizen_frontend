...
export default function OurStorySection({
  ...
  return (
    <Container variant="sectionSp1" className={bgColor}>
      <div className=" flex flex-col gap-[60px] ">
        {/* Heading */}
        <Typography variant="header-1" className={ textColor } >Our Story</Typography>

        {/* Content Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[238px] items-start">
          {/* Left Column */}
          <div className="flex flex-col gap-[50px] ">
            <Typography variant="para-2" className={textColor} >
            ...
            {showButton && <Button variant="primary">Read More</Button>}
          </div>
