        ...
        <div className="flex gap-[96px] ">
          ...
          >
            <Typography variant="para-2" className="!text-white">
              ...
              clarity on rights, governance, and risk. Our approach is centered
              on long-term value creation, helping clients make informed
              decisions at every stage of the transaction.
            </Typography>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-[15px] ">
          {cards.map((item, i) => (
            ...
            >
              ...
              <Typography variant="header-2" className="!text-white mt-[46px]">
                {item.title}
              </Typography>
